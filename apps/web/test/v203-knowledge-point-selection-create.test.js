...
assert.match(knowledgePointSelectionControllerJs, /getSelectionSnapshot/);
assert.match(knowledgePointSelectionControllerJs, /knowledgeApi\.createKnowledgePoint\(input\)/);
