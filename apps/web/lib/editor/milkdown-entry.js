  ...
  props: {
    handleDOMEvents: {
      mousedown(view, event) {
        ...
        if (typeof domPos !== 'number') return true;
        ...
        view.dispatch(view.state.tr.setNodeMarkup(
          resolvedPos.before(depth), undefined,
          { ...listItemNode.attrs, checked: newChecked }
        ));
        return true; // 阻止 ProseMirror 进一步处理
      }
    }
  }
}));
